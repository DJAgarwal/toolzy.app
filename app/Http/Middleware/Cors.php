    ...
    public function handle(Request $request, Closure $next)
    {
        ...
        if ($request->isMethod('OPTIONS')) {
            return response('', 204)
                ...
                ->header('Content-Security-Policy', "default-src 'self'; script-src 'self'; style-src 'self' 'unsafe-inline'; font-src 'self' https://cdnjs.cloudflare.com data:; frame-ancestors 'none'; form-action 'self'; base-uri 'self'; object-src 'none';");
            }
