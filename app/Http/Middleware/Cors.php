...
class Cors
{
    ...
    public function handle(Request $request, Closure $next)
    {
        ...
        $response->headers->set('Content-Security-Policy', "default-src 'self'; script-src 'self' https://toolzy.app https://www.googletagmanager.com https://www.google-analytics.com 'nonce-{$nonce}' 'unsafe-inline' https://toolzy.app/cdn-cgi/scripts/; style-src 'self' 'nonce-{$nonce}'; font-src 'self'; connect-src 'self' https://www.google-analytics.com https://cloudflareinsights.com; img-src 'self' https://www.google-analytics.com data:; object-src 'none'; frame-ancestors 'none'; base-uri 'self'; form-action 'self';");
