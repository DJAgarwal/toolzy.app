...
class Cors
{
    ...
    public function handle(Request $request, Closure $next)
    {
        ...
        $response->headers->set('Content-Security-Policy', "default-src 'self'; script-src 'nonce-{$nonce}' 'strict-dynamic' https: http: 'unsafe-inline'; style-src 'self' 'nonce-{$nonce}'; frame-ancestors 'none'; form-action 'self'; base-uri 'self'; object-src 'none';");
