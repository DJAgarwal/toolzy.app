    ...
    public function run()
    {
        $pages = [  
            ...
            [
                ...
                'category' => 'Developer & SEO Tools',
                'meta_title' => 'Online Unix Timestamp Converter & Epoch Time Tool - Toolzy',
                ...
                'json_ld' => json_encode([
                    ...
                    '@graph' => [
                        [
                            ...
                            'name' => 'Online Unix Timestamp Converter & Epoch Time Tool - Toolzy',
            ...
            [
                ...
                'category' => 'Developer & SEO Tools',
                'meta_title' => 'Lorem Ipsum & Free Placeholder Text Generator - Toolzy',
                'meta_description' => 'Generate Lorem Ipsum placeholder text instantly. Create words, sentences, paragraphs, lists, HTML content, and realistic mock content directly in your browser.',
                'json_ld' => json_encode([
                    '@context' => 'https://schema.org',
                    '@graph' => [
                        [
                            '@type' => 'WebPage',
                            '@id' => url('/tools/lorem-ipsum-generator'),
                            'name' => 'Lorem Ipsum & Free Placeholder Text Generator - Toolzy',
                            'url' => url('/tools/lorem-ipsum-generator'),
                            'description' => 'Generate Lorem Ipsum placeholder text instantly. Create words, sentences, paragraphs, lists, HTML content, and realistic mock content directly in your browser.',
                            'inLanguage' => 'en',
                            'mainEntityOfPage' => url('/tools/lorem-ipsum-generator')
                        ],
                        [
                            '@type' => 'Organization',
                            'name' => 'Toolzy',
                        ...
                        [
                            ...
                            "itemListElement"=> [
                                ...
                                [
                                    ...
                                    "item"=> url('/tools/lorem-ipsum-generator')
                                ]
                            ]
                        ],
                        [
                ...
                'json_ld' => json_encode([
                    ...
                    '@graph' => [
                        [
                            ...
                            'inLanguage' => 'en',
                            'mainEntityOfPage' => url('/tools/text-whitespace-remover')
                        ],
                        [
                            '@type' => 'Organization',
                            'name' => 'Toolzy',
                        ...
                        [
                            ...
                            "itemListElement"=> [
                                ...
                                [
                                    ...
                                    "item"=> url('/tools/text-whitespace-remover')
                                ]
                            ]
                        ],
                        [
            ...
            [
                ...
                'json_ld' => json_encode([
                    ...
                    '@graph' => [
                        [
                            '@type' => 'WebPage',
                            '@id' => url('/tools/laravel-eloquent-query-analyzer'),
                            'name' => 'Laravel Eloquent Query Analyzer & Optimizer | Improve Query Performance | Toolzy',
                            'url' => url('/tools/laravel-eloquent-query-analyzer'),
                            'description' => 'Analyze Laravel Eloquent queries for N+1 problems, eager loading, indexing opportunities, inefficient patterns, memory usage, pagination, joins, and performance improvements—all in your browser.',
                            'inLanguage' => 'en',
                            'mainEntityOfPage' => url('/tools/laravel-eloquent-query-analyzer')
                        ],
                        [
                            '@type' => 'SoftwareApplication',
                            'name' => 'Laravel Eloquent Query Analyzer & Optimizer',
                            'operatingSystem' => 'Any',
                            'applicationCategory' => 'DeveloperApplication',
                            'url' => url('/tools/laravel-eloquent-query-analyzer'),
                            'description' => 'A 100% browser-based static analysis tool for Laravel Eloquent queries, models, and relationships. Detect N+1 query bottlenecks, missing eager loading, unindexed queries, memory bloat, and pagination issues instantly.',
                            'offers' => [
                                '@type' => 'Offer',
                                'price' => '0',
                                'priceCurrency' => 'USD'
                            ...
                            'featureList' => [
                                '100% Client-Side Static Analysis (Zero Code Execution / Upload)',
                                'Laravel Eloquent Model & Relationship Inspection',
                                'N+1 Query Bottleneck & Missing Eager Loading Detection',
                                'Index Recommendations & Unindexed Query Pattern Warnings',
                                'Memory Bloat & High-Volume Data Fetch Alerts',
                                'Offset vs Cursor Pagination Performance Analysis',
                                'Multi-Database Dialect Support (MySQL, PostgreSQL, SQLite, SQL Server, MongoDB)',
                                'Side-by-Side Code Refactoring & Optimization Comparison'
                            ]
                        ],
                        [
                            '@type' => 'Organization',
                        ...
                        [
                            ...
                            'itemListElement' => [
                                ...
                                [
                                    '@type' => 'ListItem',
                                    'position' => 3,
                                    'name' => 'Laravel Eloquent Query Analyzer',
                                    'item' => url('/tools/laravel-eloquent-query-analyzer')
                                ]
                            ]
                        ]
                    ]
