...
<head>
    ...
    <meta name="keywords" content="{{ $metaKeywords ?? 'online tools, free tools, Toolzy, calculator, converter, generators, productivity tools, web utilities' }}">
    ...
    <footer class="footer-main bg-white border-top mt-auto pt-5 pb-4 text-center text-muted">
        <div class="container">
            ...
            <div class="small text-secondary">
                Toolzy.app — Toolzy - Free Online Tools, Converters & Utilities.
            </div>
            <div class="mt-3">
