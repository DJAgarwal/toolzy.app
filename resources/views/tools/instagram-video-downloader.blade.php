...
<div class="row justify-content-center">
    <div class="col-lg-12">
        ...
        {{-- Input Section --}}
        <form id="downloaderForm" class="mb-4" novalidate>
            ...
            <div class="d-flex justify-content-center mt-3 w-100">
                <button type="button" class="btn btn-primary btn-lg w-100 w-sm-auto px-sm-5 fw-bold shadow-sm d-inline-flex align-items-center justify-content-center" id="fetchBtn">
            ...
            <div class="card-body">
                <div class="row align-items-center">
                    ...
                    <div class="col-md-7">
                        ...
                        {{-- Main Action Buttons --}}
                        <div class="d-flex flex-column flex-sm-row align-items-stretch align-items-sm-center gap-2 pt-3 border-top w-100">
